...
def clean_product_table(context, params):
    ...
    # with mlflow.start_run(run_name="Cleaning Product Table"):
...
def clean_order_table(context, params):
    ...
    # with mlflow.start_run(run_name="Cleaning Order Table"):
    #     mlflow.log_artifact("~/module5/regression-py/data/" + output_dataset)
...
def clean_sales_table(context, params):
    ...
    # with mlflow.start_run(run_name="Cleaning sales table"):
    #     mlflow.log_artifact("~/module5/regression-py/data/" + output_dataset)
...
def create_training_datasets(context, params):
    ...
    sales_df_processed["first_time_customer"] = sales_df_processed[
        "first_time_customer"
    ].fillna(0)
